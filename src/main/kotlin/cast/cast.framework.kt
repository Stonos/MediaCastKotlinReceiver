...
external open class PlayerManager(params: Any = definedExternally) {
    ...
    open fun broadcastStatus(includeMedia: Boolean = definedExternally, requestId: Number = definedExternally, customData: Any = definedExternally, includeQueueItems: Boolean = definedExternally)
